...
public class LoginPageUI {
	...
	public static final String EMPTY_EMAIL_ERROR_MGS="//span[text()='Please enter a username or email address.']";
	public static final String INVALID_EMAIL_ERROR_MSG="//div[@class='form-input-validation is-error']";
	public static final String EMPTY_PASSWORD_ERROR_MSG="//div[@class='form-input-validation is-error']";
	public static final String INVALID_PASSWORD_MGS= "//div[@class='form-input-validation is-error']";
